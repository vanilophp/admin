        ...
        <div class="card-body">
            <table class="table table-striped table-hover">
                ...
                @foreach($products as $product)
                    <?php $routeResource = is_master_product($product) ? 'master-product' : 'product'; ?>
                    <tr>
                        <td>
                            @can('view products')<a href="{{ route("vanilo.admin.$routeResource.show", $product) }}">@endcan
                        ...
                        <td>
                            @can('edit products')
                                <a href="{{ route("vanilo.admin.$routeResource.edit", $product) }}"
                                   class="btn btn-xs btn-outline-primary btn-show-on-tr-hover float-right">{{ __('Edit') }}</a>
                            @endcan
                            @can('delete products')
                                {!! Form::open(['route' => ["vanilo.admin.$routeResource.destroy", $product],
                                        'method' => 'DELETE',
